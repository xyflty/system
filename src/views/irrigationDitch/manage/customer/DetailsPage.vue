  ...
  <div class="container">
    ...
    <div class="content mt_20">
      <el-tabs v-model="active" @tab-click="handleClickTab">
        ...
        <el-tab-pane label="合作项目" name="1">
          <el-tabs v-model="cooperationType" @tab-click="activeNameMet">
            <el-tab-pane label="合作证书项目" name="1"></el-tab-pane>
            <el-tab-pane label="合作安证项目" name="2"></el-tab-pane>
            <el-tab-pane label="合作资质项目" name="3"></el-tab-pane>
            <el-tab-pane label="合作人才项目" name="4"></el-tab-pane>
          </el-tabs>
        ...
        <el-tab-pane label="客户优势项目与主营项目" name="2">
...
export default {
  ...
  methods: {
    ...
    // 获取商机动态信息
    getList(id) {
      getchannelchannelCustomerId(id).then((res) => {
    ...
    getChannelRelevanceProjectList() {
      getchannelOrderProjectlist(this.AssociatedParams).then((res) => {
    ...
    // 合作项目 tab
    activeNameMet(tab) {
      this.AssociatedParams.cooperationType = this.cooperationType;
      this.getChannelRelevanceProjectList();
    },
    // tab 切换
    handleClickTab(tab, event) {
      if (tab.index == 2) {
        this.addItemListQueryParams.customerId = this.id;
        this.getChannelDomainProjectList();
      }
      if (tab.index == 1) {
        this.AssociatedParams.cooperationType = this.cooperationType;
        this.AssociatedParams.customerId = this.id;
        this.getChannelRelevanceProjectList();
      }
      if (tab.index == 3) {
        this.subsidiaryParams.customerId = this.id;
