...
<script>
import {
  listRevenueProjectCategory,
  getRevenueProjectCategory,
  delRevenueProjectCategory,
  addRevenueProjectCategory,
  updateRevenueProjectCategory,
  twoTree,
} from "@/api/newreport/revenueProjectCategory";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listRevenueProjectCategory(this.queryParams).then((response) => {
    ...
    /** 查询协同项目分类下拉树结构 */
    getTreeselect() {
      listRevenueProjectCategory().then((response) => {
    ...
    handleUpdate(row) {
      ...
      getRevenueProjectCategory(row.id).then((response) => {
        this.loading = false;
      ...
      this.$refs["form"].validate((valid) => {
        if (valid) {
          ...
          if (this.form.id != null) {
            updateRevenueProjectCategory(this.form)
              .then((response) => {
            ...
            addRevenueProjectCategory(this.form)
              .then((response) => {
    ...
    handleDelete(row) {
      this.$modal
        ...
        .then(() => {
          this.loading = true;
          return delRevenueProjectCategory(row.id);
        })
        .then(() => {
          this.loading = false;
          this.getList();
